...
namespace RelicsAPI.Auth
{
    ...
    public class TokenManager : ITokenManager
    {
        ...
        public TokenManager(IConfiguration configuration, UserManager<User> userManager, TokenValidationParameters tokenValidationParams, RelicsContext relicsContext)
        {
        ...
        public async Task<AuthResult> CreateAccessTokenAsync(User user)
        {
            ...
            await _relicsContext.RefreshTokens.AddAsync(refreshToken);
        ...
        public async Task<AuthResult> VerifyAndGenerateToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                var storedToken = await _relicsContext.RefreshTokens.FirstOrDefaultAsync(r => r.Token == tokenRequest.RefreshToken);
                ...
                _relicsContext.RefreshTokens.Update(storedToken);
                await _relicsContext.SaveChangesAsync();
